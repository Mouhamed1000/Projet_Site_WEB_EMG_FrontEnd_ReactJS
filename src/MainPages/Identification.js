function Identification () {
    return (
        <>  
            <section class="font-bold text-center text-lg mt-20">

                <div>EmgMed1000</div>

                <div class="mt-6 tracking-wide">Bienvenue ! Sélectionnez un profil afin de vous authentifier</div>
                
                <section class="flex justify-center w-full mt-14">
